 ...
 */
public class ExpBinarySearchTree<K extends Comparable<? super K>, V>
    ...
    private class BSTIterator extends SimpleIterator<Item<K, V>> {
        ...
        public BSTIterator() {
            ...
            if (ExpBinarySearchTree.this.root != null) {
                this.current = ExpBinarySearchTree.this.root;
            }
        }
        ...
        public Item<K, V> next() {
            ...
            Item<K, V> value = new Item<>(this.current);
